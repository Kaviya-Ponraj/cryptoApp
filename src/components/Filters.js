   ...
   return (
    ...
    >
        ...
        >
          ...
          placeholder='usd'
          ref={currencyRef}
          className='w-16 rounded bg-gray-200  placeholder:text-gray-100 pl-2 required outline-0 border border-transperant
        ...
        className='bg-gray-200 pl-2 pr-10 leading-4 text-base rounded capitalize py-1 focus:outline-0' 
        onClick={handleSort}
        >
        <option className='bg-gray-200 placeholder:text-gray-100' value="market_cap_asc">market cap asc</option>
        <option className='bg-gray-200 placeholder:text-gray-100' value="market_cap_desc">market cap desc</option>
        <option className='bg-gray-200 placeholder:text-gray-100' value="volume_asc">volume asc</option>
        <option className='bg-gray-200 placeholder:text-gray-100' value="volume_desc">volume desc</option>
        <option className='bg-gray-200 placeholder:text-gray-100' value="id_asc">id asc</option>
        <option className='bg-gray-200 placeholder:text-gray-100' value="id_desc">id desc</option>
        </select>
